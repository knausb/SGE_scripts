...
REF="/raid1/labs/Grunwald_Lab/web_data/pinf_broad/pinf_super_contigs"
...
CMD="/home/bpp/knausb/bin/bowtie2-2.0.6/bowtie2 -q --no-unal --rg-id ${arr[0]}.sra --rg SM:${arr[0]} --local $REF -1 ${arr[1]} -2 ${arr[2]} -S sams/${arr[0]}.sam"
echo $CMD
$CMD
